...
- `TMDB`: For most entries in the CMU movie dataset, inforamtion about the revenue is missing. We used data obtained from `The Movie Database (TMDB)` to fill missing values for revenue. 
