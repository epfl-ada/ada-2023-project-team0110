...
Further we considered Logistic Regression as Random Forest for classification and for each fold computed the accuracy alongside the recall and precision. 
...
```
Now you should be able to run both the `create_dataset.ipynb` and `milestone_3.ipynb`.
